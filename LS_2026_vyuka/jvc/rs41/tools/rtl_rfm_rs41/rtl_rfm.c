...
int main (int argc, char **argv)
{
    ...
    channel1_lo = osc_init(samplerate, -if_offset);
    ...
    int error = hw_init(&device, freq - if_offset, samplerate, gain, ppm, samplehandlerfn);
