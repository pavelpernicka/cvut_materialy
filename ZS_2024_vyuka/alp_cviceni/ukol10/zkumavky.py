...
class State:
    def __init__(self, tubes, empty_tube_index):
        self.tubes = tuple(tuple(tube) for tube in tubes)
    ...
    def __hash__(self): #udělej z této classy hashable type :LIFEHACK:
        return hash(self.tubes)

    def __eq__(self, other): #umožní porovnávání instancí třídy :LIFEHACK:
